...
{
    [QModCore]
    public static class SeaTruckSpeedQMod
    {
        /// <summary>
        ...
        public static void Patch()
        {
            ...
            /// both on-screen and in the log.
            ConsoleCommandsHandler.Main.RegisterConsoleCommand<MyCommand>("speedtruckspeed", (speedModifier) =>
            {
                return $"Parameters: {speedModifier}";
            });

            /// Here we are registering all console commands defined
            ConsoleCommandsHandler.Main.RegisterConsoleCommands(typeof(SeaTruckSpeedQMod));
        }
        private delegate string MyCommand(float speedModifier);
        ...
        public static string MyAttributedCommand(float speedModifier)
        {
            return $"Parameters: {speedModifier}";
        }
    }
