...
namespace DaftAppleGames.SubnauticaPets
{
    ...
    internal static class PrefabConfigUtilsPlatform
    {
            ...
            TechType techType, TechType dnaTechType, bool includeDnaTechType = false)
        {
            ...
            LandCreatureGravity landGravity = prefabGameObject.EnsureComponent<LandCreatureGravity>();
            landGravity.creatureRigidbody = prefabGameObject.GetComponent<Rigidbody>();
            landGravity.worldForces = worldForces;
            landGravity.liveMixin = liveMixin;
            landGravity.onSurfaceTracker = onSurfaceTracker;
            landGravity.bodyCollider = prefabGameObject.GetComponentInChildren<SphereCollider>(true);
